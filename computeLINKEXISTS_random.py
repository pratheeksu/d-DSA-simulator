...
if not os.path.exists('Nodes_co_ordinates.txt'):
    numpy.savetxt('Nodes_Co_ordinates.txt', numpy.c_[x_coordinates,y_coordinates], delimiter=',')
else:
    x_coordinates, y_coordinates = numpy.loadtxt('Nodes_Co_ordinates.txt', delimiter=',', usecols=(0, 1),
                                                unpack=True)
    print("Co-ordinates file exists")
